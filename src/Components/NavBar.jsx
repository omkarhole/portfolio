...
export const NavBar = () => {
    ...
    //mobile menue state to check whether it mobile or not 
    ...
    return (
        ...
        >
            <div className="container flex items-center gap-60 justify-around">
                <a
                    className="text-xl font-bold text-primary flex items-center"
                    href="#hero"
                >
                    <span className="relative z-10">
                        <span className="text-glow text-foreground"> Omkar </span>{" "}
                        Portfolio
                    </span>
                </a>
                ...
                {/* for mobile */}
                <button onClick={()=>setIsMenuOpen((prev)=> !prev) } className="md:hidden p-2 text-foreground z-100"
